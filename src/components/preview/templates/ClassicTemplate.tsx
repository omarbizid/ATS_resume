    ...
    const renderSection = (key: SectionKey) => {
        switch (key) {
            case 'summary': {
                ...
                return (
                    <div key={key}>
                        <h2 className="cv-heading-classic">{H.summary}</h2>
            ...
            case 'experience': {
                ...
                return (
                    <div key={key}>
                        <h2 className="cv-heading-classic">{H.experience}</h2>
                        <hr className="cv-divider" />
                        {filled.map((exp) => (
            ...
            case 'education': {
                ...
                return (
                    <div key={key}>
                        <h2 className="cv-heading-classic">{H.education}</h2>
                        <hr className="cv-divider" />
                        {filled.map((edu) => (
            ...
            case 'skills': {
                ...
                return (
                    <div key={key}>
                        <h2 className="cv-heading-classic">{H.skills}</h2>
                        <hr className="cv-divider" />
                        {filled.map((group) => (
            ...
            case 'certifications': {
                ...
                return (
                    <div key={key}>
                        <h2 className="cv-heading-classic">{H.certifications}</h2>
                        <hr className="cv-divider" />
                        {filled.map((cert) => (
            ...
            case 'languages': {
                ...
                return (
                    <div key={key}>
                        <h2 className="cv-heading-classic">{H.languages}</h2>
                        <hr className="cv-divider" />
                        <p className="cv-text" style={{ marginTop: '2px' }}>
            ...
            case 'extracurriculars': {
                ...
                return (
                    <div key={key}>
                        <h2 className="cv-heading-classic">{H.extracurriculars}</h2>
                        <hr className="cv-divider" />
                        {filled.map((item) => (
            ...
            case 'projects': {
                ...
                return (
                    <div key={key}>
                        <h2 className="cv-heading-classic">{H.projects}</h2>
                        <hr className="cv-divider" />
                        {filled.map((proj) => (
    ...
    return (
        <div className="cv-page font-['Arial',_'Helvetica',_sans-serif]">
            ...
            <div className="text-center mb-1">
                <h1 className="text-[18px] font-bold text-black tracking-wide uppercase">
                    {personal.fullName || 'Your Name'}
                </h1>
                {personal.targetTitle && (
                    <p className="text-[11px] text-gray-700 mt-0.5">{personal.targetTitle}</p>
                )}
